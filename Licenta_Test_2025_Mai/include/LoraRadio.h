...
public:
    ...
    void setSettings(){
        ...
        radio.setOutputPower(14); // change this at some point
        radio.setPreambleLength(8);
        radio.setCRC(true); 
        radio.setSyncWord(0x45); // change this too maybe
    ...
    void sendData(uint8_t *str, size_t size) {
        ...
        for (int i = 0; i < 7; ++i) {
            ...
            // if we want to also aknowledge then we need to change this (whole thing hangs here)
            delay(100);
